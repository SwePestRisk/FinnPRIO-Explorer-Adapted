...
help_add <- function(){
  tags$i() |> 
    helper(type="inline",
           size = "m",
           title = "Uncertainty",
           content = c("The whiskers for y- and x-axis show the 5th and the 95th percentiles of the score distributions."),
           buttonLabel = "OK", 
           easyClose = TRUE,
           icon = "circle-question",
           colour = "#912D20",
...
help_pw_a_h <- function(){
  tags$i() |> 
    helper(type="inline",
           ...
           title = "Pathways",
           content = c("",
                       "The pathways are assessed in order of their likelihood, i.e.",
